...
public class VideoChatUserInfo extends VideoChatResponse implements Parcelable {
    ...
    public VideoChatUserInfo deepCopy() {
        VideoChatUserInfo info = new VideoChatUserInfo();
        info.roomId = roomId;
        info.userId = userId;
    ...
    public VideoChatUserInfo() {
    }

    protected VideoChatUserInfo(Parcel in) {
    ...
    public static final Parcelable.Creator<VideoChatUserInfo> CREATOR = new Parcelable.Creator<VideoChatUserInfo>() {
        @Override
        public VideoChatUserInfo createFromParcel(Parcel source) {
            return new VideoChatUserInfo(source);
        }

        @Override
        public VideoChatUserInfo[] newArray(int size) {
            return new VideoChatUserInfo[size];
        }
    };
}

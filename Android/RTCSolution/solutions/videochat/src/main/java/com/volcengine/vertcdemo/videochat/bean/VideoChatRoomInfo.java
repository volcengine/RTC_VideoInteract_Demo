...
public class VideoChatRoomInfo implements Parcelable {
    ...
    public VideoChatRoomInfo() {
    }

    protected VideoChatRoomInfo(Parcel in) {
    ...
    public static final Parcelable.Creator<VideoChatRoomInfo> CREATOR = new Parcelable.Creator<VideoChatRoomInfo>() {
        @Override
        public VideoChatRoomInfo createFromParcel(Parcel source) {
            return new VideoChatRoomInfo(source);
        }

        @Override
        public VideoChatRoomInfo[] newArray(int size) {
            return new VideoChatRoomInfo[size];
        }
    };
}
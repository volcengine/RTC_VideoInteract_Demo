...
import com.volcengine.vertcdemo.videochat.bean.GetAudienceResponse;
...
import com.volcengine.vertcdemo.videochat.bean.ManageOtherAnchorBroadcast;
import com.volcengine.vertcdemo.videochat.bean.MediaChangedBroadcast;
import com.volcengine.vertcdemo.videochat.bean.MediaOperateBroadcast;
...
public class VideoChatRTSClient extends RTSBaseClient {
    ...
    public void requestClearUser(IRequestCallback<VideoChatResponse> callback) {
        ...
        sendServerMessageOnNetwork("", params, VideoChatResponse.class, callback);
    }
    ...
    public void requestStartLive(String roomId, IRequestCallback<VideoChatUserInfo> callback) {
        JsonObject params = getCommonParams(CMD_START_LIVE);
        params.addProperty("room_id", roomId);
        sendServerMessageOnNetwork(roomId, params, VideoChatUserInfo.class, callback);
    }

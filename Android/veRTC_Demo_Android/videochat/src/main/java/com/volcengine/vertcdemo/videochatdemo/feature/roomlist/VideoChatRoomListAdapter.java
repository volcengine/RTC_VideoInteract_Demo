...
public class VideoChatRoomListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public VideoChatRoomListAdapter(IAction<VCRoomInfo> onClickRoomInfo) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_video_chat_demo_room_list, parent, false);
    ...
    private static class VoiceChatRoomListViewHolder extends RecyclerView.ViewHolder {
        ...
        public VoiceChatRoomListViewHolder(@NonNull View itemView, IAction<VCRoomInfo> onClickRoomInfo) {
            ...
            Drawable drawable = itemView.getContext().getResources().getDrawable(
                    R.drawable.video_chat_demo_room_list_audience_icon);

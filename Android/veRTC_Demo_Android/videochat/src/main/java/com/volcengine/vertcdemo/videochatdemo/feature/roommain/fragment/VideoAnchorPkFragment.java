...
public class VideoAnchorPkFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMuteRemoteIv.setImageResource(mPeerAnchorMuted
                ? R.drawable.video_chat_demo_main_pk_mute_remote
                : R.drawable.video_chat_demo_main_pk_unmute_remote);
        //观众没有mute权限
    ...
    private void updateNetStatus(TextView textView, int networkQuality) {
        ...
        boolean good = networkQuality == IRTCEngineEventHandler.NetworkQuality.NETWORK_QUALITY_GOOD ||
                networkQuality == IRTCEngineEventHandler.NetworkQuality.NETWORK_QUALITY_EXCELLENT;
        textView.setText(good ? "网络良好" : "网络卡顿");

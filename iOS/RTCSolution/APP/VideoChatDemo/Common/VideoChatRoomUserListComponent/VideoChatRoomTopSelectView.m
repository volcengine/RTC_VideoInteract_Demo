...
@interface VideoChatRoomTopSelectView ()
...
@implementation VideoChatRoomTopSelectView
...
- (void)cancelButtonAction {
    if ([self.delegate respondsToSelector:@selector(VideoChatRoomTopSelectView:clickCancelAction:)]) {
        [self.delegate VideoChatRoomTopSelectView:self clickCancelAction:@""];
    }
}
...
- (BaseButton *)onlineButton {
    if (!_onlineButton) {
        ...
        [_onlineButton setTitle:LocalizedString(@"video_chat_online_audience") forState:UIControlStateNormal];
...
- (BaseButton *)appleButton {
    if (!_appleButton) {
        ...
        [_appleButton setTitle:LocalizedString(@"video_chat_application_message") forState:UIControlStateNormal];
...
- (UIImageView *)redImageView {
    if (!_redImageView) {
        ...
        _redImageView.image = [UIImage imageNamed:@"videochat_bottom_red" bundleName:HomeBundleName];

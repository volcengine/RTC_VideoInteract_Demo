...
@interface VideoChatCreateRoomTipView ()
...
@implementation VideoChatCreateRoomTipView
...
- (UIImageView *)tipImageView {
    if (!_tipImageView) {
        ...
        _tipImageView.image = [UIImage imageNamed:@"videochar_waring" bundleName:HomeBundleName];
    }

...
@interface VideoChatIMView ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) UITableView *roomTableView;

@end

@implementation VideoChatIMView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    VideoChatIMCell *cell = [tableView dequeueReusableCellWithIdentifier:@"videoChatIMCellID" forIndexPath:indexPath];
...
- (UITableView *)roomTableView {
    if (!_roomTableView) {
        ...
        [_roomTableView registerClass:VideoChatIMCell.class forCellReuseIdentifier:@"videoChatIMCellID"];

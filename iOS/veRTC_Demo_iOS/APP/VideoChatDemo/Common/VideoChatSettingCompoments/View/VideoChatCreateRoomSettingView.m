//
//  VideoChatCreateRoomSettingView.m
//  veRTC_Demo
//
...
- (VideoChatSettingSingleSelectView *)fpsSelectView {
    if (!_fpsSelectView) {
        _fpsSelectView = [[VideoChatSettingSingleSelectView alloc] initWithTitle:@"帧率" optionArray:@[ @"15", @"20" ]];
    }
...
- (VideoChatSettingSingleSelectView *)resolutoinSelectView {
    if (!_resolutoinSelectView) {
        _resolutoinSelectView = [[VideoChatSettingSingleSelectView alloc] initWithTitle:@"分辨率" optionArray:@[ @"480p", @"540p", @"720p", @"1080p" ]];
    }

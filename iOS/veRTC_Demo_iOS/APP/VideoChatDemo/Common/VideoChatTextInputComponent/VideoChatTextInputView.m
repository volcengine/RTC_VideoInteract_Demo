...
@interface VideoChatTextInputView ()
...
@implementation VideoChatTextInputView
...
- (UIImageView *)borderImageView {
    if (!_borderImageView) {
        ...
        _borderImageView.image = [UIImage imageNamed:@"videochat_textinput_border" bundleName:HomeBundleName];
    }

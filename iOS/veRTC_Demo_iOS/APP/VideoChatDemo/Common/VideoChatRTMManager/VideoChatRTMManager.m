...
+ (void)createRoom:(NSString *)roomName
    ...
    [[VideoChatRTCManager shareRtc] emitWithAck:@"viCreateRoom" with:dic block:^(RTMACKModel * _Nonnull ackModel) {
        ...
        if ([VideoChatRTMManager ackModelResponseClass:ackModel]) {
...
+ (void)onAudienceJoinRoomWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnAudienceJoinRoom" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onAudienceLeaveRoomWithBlock:(void (^)(VideoChatUserModel *userModel,
                                               NSInteger count))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnAudienceLeaveRoom" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onFinishLiveWithBlock:(void (^)(NSString *rommID, NSInteger type))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnFinishLive" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onJoinInteractWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnJoinInteract" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onFinishInteractWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnFinishInteract" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onSeatStatusChangeWithBlock:(void (^)(NSString *seatID,
                                              NSInteger type))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnSeatStatusChange" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onMediaStatusChangeWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnMediaStatusChange" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onMessageWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnMessage" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onInviteInteractWithBlock:(void (^)(VideoChatUserModel *hostUserModel,
                                            NSString *seatID))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnInviteInteract" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onInviteResultWithBlock:(void (^)(VideoChatUserModel *userModel,
    ...
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnInviteResult" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onApplyInteractWithBlock:(void (^)(VideoChatUserModel *userModel,
                                           NSString *seatID))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnApplyInteract" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onMediaOperateWithBlock:(void (^)(NSInteger mic, NSInteger camera))block  {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnMediaOperate" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onClearUserWithBlock:(void (^)(NSString *uid))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnClearUser" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onAnchorInviteWithBlock:(void (^)(VideoChatUserModel * _Nonnull))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnAnchorInvite" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onAnchorReplyWithBlock:(void (^)(VideoChatPKReply, NSString * _Nonnull, NSString * _Nonnull, VideoChatUserModel * _Nonnull))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnAnchorReply" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onNewAnchorJoinWithBlock:(void (^)(VideoChatUserModel * _Nonnull))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnNewAnchorJoin" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onAnchorPKEndWithBlock:(void(^)(void))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnAnchorInteractFinish" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onClosedChatRoomModeWithBlock:(void(^)(NSString *roomID))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnCloseChatRoom" block:^(RTMNoticeModel * _Nonnull noticeModel) {
...
+ (void)onMuteOtherAnchorWithBlock:(void(^)(NSString *roomID, NSString *otherAnchorUserID, VideoChatOtherAnchorMicType type))block {
    [[VideoChatRTCManager shareRtc] onSceneListener:@"viOnManageOtherAnchor" block:^(RTMNoticeModel * _Nonnull noticeModel) {

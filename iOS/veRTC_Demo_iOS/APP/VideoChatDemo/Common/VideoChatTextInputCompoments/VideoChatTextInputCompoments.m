//
//  VideoChatTextInputCompoments.m
//  veRTC_Demo
//
...
@interface VideoChatTextInputCompoments ()

@property (nonatomic, weak) UIView *superView;
@property (nonatomic, weak) UIView *contentView;
@property (nonatomic, weak) VideoChatTextInputView *textInputView;
@property (nonatomic, strong) VideoChatRoomModel *roomModel;
@property (nonatomic, copy) NSString *textMessage;

@end

@implementation VideoChatTextInputCompoments
...
- (void)loadDataWithSendeMessage:(NSString *)message {
    [VideoChatRTMManager sendMessage:self.roomModel.roomID
                                    message:message

...
@interface VideoChatSeatCompoments () <VideoChatSheetViewDelegate>
...
@implementation VideoChatSeatCompoments
...
- (void)VideoChatSheetView:(VideoChatSheetView *)VideoChatSheetView
    ...
    if (sheetState == VideoChatSheetStatusInvite) {
        if ([self.delegate respondsToSelector:@selector
             (VideoChatSeatCompoments:clickButton:sheetStatus:)]) {
            [self.delegate VideoChatSeatCompoments:self

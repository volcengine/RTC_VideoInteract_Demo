...
- (void)updateUI:(VideoChatSeatItemStatue)statue
    ...
    if (statue == VideoChatSeatItemStatueNull) {
        ...
        self.userNameView.userModel = seatModel.userModel;
        self.avatarComponent.text = seatModel.userModel.name;
        self.avatarComponent.hidden = (seatModel.userModel.camera == VideoChatUserCameraOn) ? YES : NO;

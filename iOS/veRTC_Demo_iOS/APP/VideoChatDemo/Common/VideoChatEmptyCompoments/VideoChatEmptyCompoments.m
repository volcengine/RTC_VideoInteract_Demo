...
@interface VideoChatEmptyCompoments ()
...
@implementation VideoChatEmptyCompoments
...
- (UIImageView *)iconImageView {
    if (!_iconImageView) {
        ...
        _iconImageView.image = [UIImage imageNamed:@"videochar_empty" bundleName:HomeBundleName];
    }

...
var (
	...
	ErrUserStatusNotMatchAction    = NewCustomError(551, errors.New("user status not match current action"))
	ErrRelationCount               = NewCustomError(807, errors.New("relations count error"))
)

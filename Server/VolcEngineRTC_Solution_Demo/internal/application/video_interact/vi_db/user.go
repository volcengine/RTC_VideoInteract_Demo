...
func (repo *DbUserRepo) Save(ctx context.Context, user *vi_entity.ViUser) error {
...
func (repo *DbUserRepo) GetActiveAnchors(ctx context.Context, appID string) ([]*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs []*vi_entity.ViUser
	err := db.Client.WithContext(ctx).Debug().Table(UserTable).Where("app_id=? and  net_status = ? and user_role = ?", appID, UserNetStatusOnline, UserRoleHost).Order("create_time desc").Limit(200).Find(&rs).Error
	if err != nil {
...
func (repo *DbUserRepo) GetActiveUserByRoomIDUserID(ctx context.Context, appID, roomID, userID string) (*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs *vi_entity.ViUser
...
func (repo *DbUserRepo) GetUserByRoomIDUserID(ctx context.Context, appID, roomID, userID string) (*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs *vi_entity.ViUser
...
func (repo *DbUserRepo) GetActiveUserByUserID(ctx context.Context, appID, userID string) (*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs *vi_entity.ViUser
...
func (repo *DbUserRepo) GetActiveUsersByRoomID(ctx context.Context, appID, roomID string) ([]*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs []*vi_entity.ViUser
...
func (repo *DbUserRepo) GetAudiencesWithoutApplyByRoomID(ctx context.Context, appID, roomID string) ([]*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs []*vi_entity.ViUser
...
func (repo *DbUserRepo) GetApplyAudiencesByRoomID(ctx context.Context, appID, roomID string) ([]*vi_entity.ViUser, error) {
	defer util.CheckPanic()
	var rs []*vi_entity.ViUser
	err := db.Client.WithContext(ctx).Debug().Table(UserTable).Where("app_id =? and room_id= ? and net_status = ? and interact_status = ? and user_role = ?", appID, roomID, UserNetStatusOnline, UserInteractStatusApplying, UserRoleAudience).Order("create_time desc").Limit(200).Find(&rs).Error
	if err != nil {
